...
function Team({ containerOn, meetRef, profileRef }: {
    ...
    return (
        <div className="h-screen flex flex-col md:flex-row md:mx-8 lg:mx-16 gap-8 justify-center py-20">
            ...
            <div ref={profileRef} className="w-full md:w-2/5 content-start">
